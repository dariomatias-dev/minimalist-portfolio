...
export const MobileMenu = ({
  ...
  return (
    <div
      className={`fixed inset-0 z-40 flex h-screen w-screen transform flex-col items-center bg-white/97 text-lg font-semibold text-gray-800 backdrop-blur-md transition-all duration-300 ease-in-out md:hidden dark:bg-black/97 dark:text-gray-200 ${
        isVisible
