    ...
    <section className="my-36 sm:my-40 md:my-48">
      <div className="mx-auto max-w-3xl px-6">
        <blockquote className="text-center">
          ...
          <p className="text-4xl font-extrabold tracking-tight text-gray-900 italic lg:text-[2.625rem] lg:leading-tight">
            “{quote}”
          </p>

          <footer className="mt-8 text-lg text-gray-600">— {author}</footer>
